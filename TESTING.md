...
| `runtime.composition.auto` | production_provider | — | `runtime.Provider` | `internal/runtime/auto.New` | source: cmd/gc/providers.go#resolveSessionTransportProviderBase — conditional transport composition is outside the runtime registry | `runtime.Provider` | proved by internal/runtime/auto/conformance_test.go#TestAutoConformance (default-route conformance; ACP route covered by focused auto routing tests) |
| `runtime.composition.router` | production_provider | — | `runtime.Provider` | `internal/runtime/router.New` | source: cmd/gc/runtime_routing.go#composeLaneRuntimeProvider — conditional lane-scoped runtime composition is outside the runtime registry | `runtime.Provider` | proved by internal/runtime/router/router_test.go#TestRouterConformance (default-route conformance; routed lanes covered by focused router routing tests) |
