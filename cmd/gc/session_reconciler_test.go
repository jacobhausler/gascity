...
func TestResolveSessionCommand(t *testing.T) {
	...
	t.Run("first start without SessionIDFlag keeps the launch command", func(t *testing.T) {
	...
	t.Run("fresh wake without SessionIDFlag keeps the launch command", func(t *testing.T) {
		noSessionID := &config.ResolvedProvider{ResumeFlag: "--resume"}
