...
// workflow roots, scope/run/check/drain steps, etc.), workflow steps identified
// by gc.step_id or gc.step_ref, or non-task beads (convoy, message). Those use
// the disjoint control-plane gc.outcome vocabulary and are closed by the
